    ...
    if (data != null) {
      ...
      if (role == 'lawyer') {
        ...
        if (isSubscribed) {
          ...
          // If dismissed/failed, stay on login screen
        }
      }
      return;
    }
...
class _SubscriptionGateDialogState extends State<_SubscriptionGateDialog> {
  ...
  Future<void> _confirmPayment() async {
    ...
    if (result.success) {
      ...
      setState(() { _loading = false; _error = result.error ?? 'התשלום לא אושר. נסה שוב.'; });
    }
  }
    ...
    return Directionality(
      ...
      child: AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              'כדי להשתמש ב-VETO נדרש מנוי חודשי.',
            ...
            Container(
              ...
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 8),
                  Text('✓ ייעוץ AI משפטי ללא הגבלה\n✓ הזמנת עורך דין חירום (₪50 נוסף)', style: TextStyle(color: Color(0xFF94A3B8), fontSize: 13)),
                ],
              ),
            ),
            if (_error != null) ...[
            ...
            if (_orderId != null) ...[
              ...
              Container(
                ...
                child: const Text(
                  'שילמת ב-PayPal? לחץ "אישור תשלום" למטה',
