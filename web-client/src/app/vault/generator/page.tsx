  ...
  return (
    <div className="flex min-h-full flex-col pb-[calc(10rem+env(safe-area-inset-bottom))]" dir="rtl">
      <main className="mx-auto grid w-full max-w-7xl flex-1 gap-5 px-4 pb-[calc(10rem+env(safe-area-inset-bottom))] pt-5 lg:grid-cols-[360px_minmax(0,1fr)]">
        <aside data-print="hide" className={`${glassPanel} h-fit p-5 lg:sticky lg:top-20`}>
          <Link href="/vault" className="mb-4 inline-flex items-center gap-2 text-sm font-bold text-secondary hover:text-primary">
            <ArrowRight className="h-4 w-4" aria-hidden />
            חזרה לכספת
          </Link>

          <h1 className="font-frank text-2xl font-black text-primary">מחולל מסמכים משפטיים</h1>
        ...
        <section className={`${glassPanel} min-h-[70vh] p-4 md:p-8`}>
          {!document ? (
            <div className="grid min-h-[60vh] place-items-center text-center text-muted">
              <div>
                <FileText className="mx-auto mb-4 h-16 w-16 stroke-1 text-veto-gold-dark" aria-hidden />
            ...
            <article
              ref={documentRef}
              data-print="root"
              className="mx-auto min-h-[297mm] w-full max-w-[210mm] bg-surface-overlay p-8 text-primary shadow-xl md:p-14 print:m-0 print:max-w-none print:shadow-none"
              contentEditable
