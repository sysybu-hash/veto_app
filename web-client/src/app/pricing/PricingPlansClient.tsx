              ...
              {plan.featured ? (
                <div className="mt-7 space-y-3">
                  <Link
                    ...
                    className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-veto-gold/60 bg-veto-gold px-5 py-3 text-sm font-black text-brand-fg shadow-[0_0_24px_-8px_rgba(197,160,89,0.8)] transition hover:bg-veto-gold-light"
                  >
